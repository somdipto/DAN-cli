...
import { ChangeTrackingService } from '../services/changeTrackingService.js';
...
export class Config {
  ...
  constructor(params: ConfigParameters) {
    ...
    this.changeTrackingService = new ChangeTrackingService(this);
