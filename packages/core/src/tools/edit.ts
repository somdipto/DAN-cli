...
class EditToolInvocation implements ToolInvocation<EditToolParams, ToolResult> {
  ...
  async execute(signal: AbortSignal): Promise<ToolResult> {
    ...
    try {
      ...
      const changeTrackingService = this.config.getChangeTrackingService();
      ...
      // Register the change with the tracking service
      if (editData.isNewFile) {
        await changeTrackingService.registerCreate(this.params.file_path, editData.newContent, EditTool.Name);
      } else {
        await changeTrackingService.registerUpdate(this.params.file_path, editData.currentContent ?? '', editData.newContent, EditTool.Name);
      }
