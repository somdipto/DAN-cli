...
> {
  ...
  async execute(_abortSignal: AbortSignal): Promise<ToolResult> {
    ...
    try {
      ...
      if (isNewFile) {
        await changeTrackingService.registerCreate(file_path, fileContent, WriteFileTool.Name);
      } else {
        await changeTrackingService.registerUpdate(file_path, originalContent, fileContent, WriteFileTool.Name);
      }
